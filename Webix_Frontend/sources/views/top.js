    ...
    confirmLogout() {
        webix.ui({
            ...
            body: {
                ...
                rows: [
                    {
                        template: "<div style='text-align: center; font-weight: 600; color: #666;'>Confirm Logout</div>",
                        autoheight: true,
                        borderless: true
                    },
                    { height: 15 },
                    {
                        template: "<div style='text-align: center; color: #666; line-height: 1.5;'>Are you sure you want to logout from your account?</div>",
                        autoheight: true,
                        borderless: true
                    },
                    { height: 30 },
